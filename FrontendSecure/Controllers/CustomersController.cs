...
namespace FrontendSecure.Controllers
{
    ...
    public class CustomersController : Controller
    {
        ...
        public ActionResult CustomerTableExpressPartialAddNew([ModelBinder(typeof(DevExpressEditorsBinder))] Entities.Entities.Customer item)
        {
        ...
        [HttpPost, ValidateInput(false)]
        public ActionResult CustomerTableExpressPartialUpdate([ModelBinder(typeof(DevExpressEditorsBinder))] Entities.Entities.Customer item)
        {
            var model = new object[0];
            if (ModelState.IsValid)
            {
